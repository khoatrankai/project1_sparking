...
export default function ListPropose() {
  ...
  const createExcelPriceQuote = async (dataPriceQuote: IExportPriceQuote) => {
    ...
    const imageId = workbook.addImage({
      ...
      extension: "png", // Hoặc 'png' tùy thuộc vào định dạng ảnh
    });
    ...
    worksheet.getCell("B14").value = {
      richText: [
        ...
        {
          text: dataPriceQuote.project.customer.name_company.toUpperCase(),
          font: { bold: true },
        },
      ],
    };
    worksheet.getCell("B15").value = {
      richText: [
        ...
        {
          text: (
            dataPriceQuote.project.customer.address_delivery +
            "," +
    ...
    worksheet.getCell("B17").value = {
      richText: [
        ...
        {
          text: dataPriceQuote.project.customer.phone_number.toUpperCase(),
          font: { bold: true },
        },
      ],
    };
    worksheet.getCell("B18").value = {
      richText: [
        ...
        {
          text: dataPriceQuote.project.customer.phone_number,
          font: { bold: true },
        },
      ],
    };
