...
import ModalUpdateActivityImport from "../Tool/Modal/ModalUpdateActivityImport/ModalUpdateActivityImport";
import { IGetActivityContainer } from "@/models/productInterface";

export default function ListActivityImport() {
      ...
      render: (value: string, red, index) => (
        <div className="flex flex-col gap-1 ">
          ...
          <div className="flex gap-2">
            ...
            <ModalUpdateActivityImport ID={value} />
          </div>
        </div>
      ),
