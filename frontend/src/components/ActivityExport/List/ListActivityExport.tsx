...
import ModalUpdateActivityExport from "../Tool/Modal/ModalUpdateActivityExport/ModalUpdateActivityExport";

export default function ListActivityExport() {
      ...
      render: (value: string, red, index) => (
        <div className="flex flex-col gap-1 ">
          ...
          <div className="flex gap-2">
            ...
            <ModalUpdateActivityExport ID={value} />
          </div>
        </div>
      ),
