...
import { ICreateActivity, IGetActivity, IUpdateActivity } from '@/models/activityInterface';
...
export const updateActivity = createAsyncThunk(
  ...
  async ({ activity_id, data }: { activity_id: string; data: IUpdateActivity }, thunkAPI) => {
    try {
