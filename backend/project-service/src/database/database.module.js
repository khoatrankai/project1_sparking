...
var type_project_entity_1 = require("./entities/type_project.entity");
                ...
                typeorm_1.TypeOrmModule.forRootAsync({
                    ...
                    useFactory: function (configService) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, (0, promise_1.createConnection)({
                                ...
                                case 1:
                                    connection = _a.sent();
                                    return [4 /*yield*/, connection.query("CREATE DATABASE IF NOT EXISTS ".concat(configService.get('DB_NAME')))];
                                case 2:
                                    _a.sent();
                                ...
                                case 3:
                                    ...
                                    return [2 /*return*/, {
                                            ...
                                            entities: [project_entity_1.Projects, type_project_entity_1.TypeProject],
                                            // synchronize: true,
                                            // dropSchema: true,
                                        }];
                            }
