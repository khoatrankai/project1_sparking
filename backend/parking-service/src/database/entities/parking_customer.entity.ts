...
export class ParkingCustomer {
  ...
  @ManyToOne(() => ParkingApartment, (apartment) => apartment.customers, {
    nullable: true,
  })
  @JoinColumn({ name: 'apartment_id' })
  apartment: ParkingApartment;

  @ManyToOne(() => ParkingBuilding, (building) => building.customers, {
    nullable: true,
  })
  @JoinColumn({ name: 'building_id' })
  building: ParkingBuilding;

  @ManyToOne(() => ParkingCompany, (company) => company.customers, {
    nullable: true,
  })
  ...
  @ManyToOne(
    () => ParkingCustomerType,
    (customerType) => customerType.customers,
    { nullable: true },
  )
