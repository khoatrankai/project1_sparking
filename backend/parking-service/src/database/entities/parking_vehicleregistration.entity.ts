...
export class ParkingVehicleRegistration {
  ...
  @ManyToOne(() => ParkingCustomer, customer => customer.parkingVehicleRegistrations)
  @JoinColumn({ name: 'customer_id' })
  customer: ParkingCustomer;

  @ManyToOne(() => ParkingLevelFee, levelFee => levelFee.parkingVehicleRegistrations)
  @JoinColumn({ name: 'level_fee_id' })
  levelFee: ParkingLevelFee;

  @ManyToOne(() => ParkingVehicleType, vehicleType => vehicleType.parkingVehicleRegistrations)
  @JoinColumn({ name: 'vehicle_type_id' })
  vehicleType: ParkingVehicleType;

  @ManyToOne(() => ParkingUserProfile, userProfile => userProfile.parkingVehicleRegistrations)
  ...
  @OneToMany(() => ParkingDepositPaymentDetail, (post) => post.vehicleRegistration)
  depositPaymentDetail: ParkingDepositPaymentDetail[];

  @OneToMany(() => ParkingTicketPaymentDetail, (post) => post.vehicleRegistration)
