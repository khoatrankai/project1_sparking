...
export class ParkingTicketPayment {
  ...
  @ManyToOne(() => ParkingCustomer, (customer) => customer.ticketPayments, { nullable: true })
  ...
  @ManyToOne(() => ParkingUserProfile, (user) => user.ticketPayments, { nullable: true })
  @JoinColumn({ name: 'staff_id' })
  staff: ParkingUserProfile;

  @OneToMany(() => ParkingTicketPaymentDetail, (terminal) => terminal.ticketPayment)
