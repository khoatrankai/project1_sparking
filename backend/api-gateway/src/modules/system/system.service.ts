...
export class SystemService {
  ...
  async createTypeProduct(createTypeProductDto: CreateTypeProductDto) {
    return this.systemClient.send({ cmd: 'create-type_product' }, createTypeProductDto);
  }
  
  async updateTypeProduct(updateTypeProductDto: UpdateTypeProductDto) {
    return this.systemClient.send({ cmd: 'update-type_product' }, updateTypeProductDto);
  }
  ...
  async updateUnitProduct(updateUnitDto: UpdateUnitProductDto) {
    return this.systemClient.send({ cmd: 'update-unit_product' }, updateUnitDto);
  }
  ...
  async getAllProvinces():Promise<{statusCode:number,data:GetProvinceDto[]}> {
    return {
      ...
      data:await firstValueFrom(this.systemClient.send<GetProvinceDto[]>({ cmd: 'get-provinces' }, {}))
    };
  }
  ...
  async createPictureProduct(createPictureProductDto: CreatePictureProductDto) {
    return this.systemClient.send({ cmd: 'create-picture_product' }, createPictureProductDto);
  }
  
  async updatePictureProduct(updatePictureProductDto: UpdatePictureProductDto) {
    return this.systemClient.send({ cmd: 'update-picture_product' }, updatePictureProductDto);
  }
  ...
  async getPictureProductById(pictureId: string) {
    return this.systemClient.send({ cmd: 'get-picture_product_by_id' }, pictureId);
  }
  ...
  async createListUseProduct(createListUseProductDto: CreateListUseProductDto) {
    return this.systemClient.send({ cmd: 'create-list_use_product' }, createListUseProductDto);
  }
  
  async updateListUseProduct(updateListUseProductDto: UpdateListUseProductDto) {
    return this.systemClient.send({ cmd: 'update-list_use_product' }, updateListUseProductDto);
  }
